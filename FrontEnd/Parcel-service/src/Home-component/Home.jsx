  ...
  return (
    <div>
      ...
      <div className="Home_card_group">
        <div className="Home_card">
          ...
          <div className="Home_card_body">
            ...
            <p className="Home_card_text">
              ...
              provide an unrivalled range of green logistics solutions. Learn
        ...
        <div className="Home_card">
          ...
          <div className="Home_card_body">
            ...
            <p className="Home_card_text">
              Customers, academic and research institutes, commercial partners,
              and logistics specialists are all brought together by the
              corporation throughout the many Parcel Service business divisions
              to facilitate collaboration. As a pioneer in the logistics sector,
              Parcel Service strategically invests in the study of trends and
        ...
        <div className="Home_card">
          ...
          />
          <div className="Home_card_body">
            <h5 className="Home_Card_title">Parcel Service Global Connectedness Index</h5>
            <p className="Home_card_text">
        ...
        <div className="Home_row">
          ...
          <div className="Home_column">
            <form action="/action_page.php">
              ...
              <input className='Home_Input' type="text" id="fname" name="firstname" placeholder="Your name.." />
              <label htmlFor="lname">Email</label>
              <input className="Home_Input"type="text" id="lname" name="lastname" placeholder="Your last name.." /><br></br>
      ...
      <div className="Home_footer_sub1" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
        © 2023 Copyright:
        <a className="Home_fouter_sub2" href="#">ParcelService.com</a>
      </div>
